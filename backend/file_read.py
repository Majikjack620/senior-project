...
with open('dependent.txt', 'r') as depend:
  ...
  # If the file is not empty, we make a table out of it's content
    ...
    print("""- Ensure that, at least, the dependency that is being updated in the ***package.json*** file has a
    ...
    print("- Run one of the following command in your CLI to update the dependency to the latest version:")
    print("  - ***npm update {DEPENDENCY_NAME}***")
    print("  - ***npm install {DEPENDENCY_NAME}@latest***")
    print("- Run the following command in your CLI to update the dependency to a specific version:")
    ...
    print("""- Ensure that ALL dependencies in the ***package.json*** file has a
    '***^***' in front of the version number (i.e. ***"@aws-sdk/client-dynamodb": "^3.351.0"***""")
    print("- Go inside the folder with the ***package.json*** file from your CLI")
